...
namespace RealEstate_Dapper_UI.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage5 = await client5.GetAsync("https://localhost:44338/api/Statistics/AverageProductPriceBySale");
            ...
            var responseMessage6 = await client6.GetAsync("https://localhost:44338/api/Statistics/AvereageRoomCount");
            ...
            var responseMessage8 = await client8.GetAsync("https://localhost:44338/api/Statistics/CategoryNameByMaxProductCount");
            ...
            var responseMessage9 = await client9.GetAsync("https://localhost:44338/api/Statistics/CityNameByMaxProductCount");
            ...
            var responseMessage10 = await client10.GetAsync("https://localhost:44338/api/Statistics/DifferentCityCount");
            ...
            var responseMessage11 = await client11.GetAsync("https://localhost:44338/api/Statistics/EmployeeNameByMaxProductCount");
