...
namespace RealEstate_Dapper_UI.ViewComponents.EstateAgent
{
    public class _EstateAgentDashboardStatisticComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:44338/api/EstateAgentDashboardStatistic/ProductCountByStatusTrue?id=" + id);
            ...
            var responseMessage4 = await client4.GetAsync("https://localhost:44338/api/EstateAgentDashboardStatistic/ProductCountByStatusFalse?id=" + id);
